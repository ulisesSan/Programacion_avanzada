...
<div class="p1">
    <div class="healer" >
        <center>
        <h2>Tablas de referencias cruzadas</h2>
        <p id="linea"></p>
        <h4>Esta tabla deberá de presentar datos a mostrar en forma TABULAR</h4>
        <h4>Deberá de tener por lo menos dos tablas de la base de datos.
        </h4>
            <p id="linea"></p>
            <h5></h5>
        </center>
...
<div>
    <form action="c8r.php" method="post">
